...
DATA_HARVEST_TYPE_IMPORT_TIERS = 6
DATA_HARVEST_TYPE_IMPORT_CLOUD_DATA = 7
...
DATA_HARVEST_TYPE_CHOICES = (
    ...
    (DATA_HARVEST_TYPE_IMPORT_TIERS, 'tier status'),
    (DATA_HARVEST_TYPE_IMPORT_CLOUD_DATA, 'cloud data')
)
